                ...
                -->
				    ...
				    @foreach ($data as $d)
				        ...
				        <tr>
				        	...
				        	<td>
				        	@if ($d->status == "PRINTED")
				        		<a href="{{ url('/delete_line_sap/'.$d->lineid) }}" class="btn btn-danger btn-xs center-block" disabled>Cancel line</a>
				        	@else
				        		<a href="{{ url('/delete_line_sap/'.$d->lineid) }}" class="btn btn-danger btn-xs center-block" >Cancel line</a>
				        	@endif
				        	</td>
