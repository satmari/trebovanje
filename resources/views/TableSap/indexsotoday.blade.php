                ...
                -->
				    ...
				    @foreach ($data as $d)
				        ...
				        <tr>
				        	...
				        	<td>
				        		<a href="{{ url('/request_lines_sap/'.$d->id) }}" class="btn btn-default btn-xs center-block">Request Lines</a>
				        	</td>
				        	<td>
				        	...
				        	@else 
				        		@if ($d->status == "PRINTED") 
				        			<a href="{{ url('/print_sap/'.$d->id) }}" class="btn btn-info btn-xs center-block">Print</a>
				        		@else
				        			<a href="{{ url('/print_sap/'.$d->id) }}" class="btn btn-info btn-xs center-block" disabled>Print</a>
				        		@endif
				        	@endif
				        	</td>
				        	<td>
				        	...
				        	<td>
				        		<a href="{{ url('/edit_header_sap/'.$d->id) }}" class="btn btn-default btn-xs center-block" >Edit</a>
				        	</td>
